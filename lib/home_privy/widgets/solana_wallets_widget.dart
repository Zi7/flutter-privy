...
import '../../wallet/solana_wallet_screen.dart';
...
class SolanaWalletsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(
      'user.embeddedSolanaWallets id: ${user.embeddedSolanaWallets.first.id}',
    );
    return Column(
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => SolanaWalletScreen(solanaWallet: wallet),
          ),
        );
      },
      child: Card(
