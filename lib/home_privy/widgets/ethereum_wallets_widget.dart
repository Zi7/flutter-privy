...
import '../../wallet/eth_wallet_screen.dart';
...
class EthereumWalletsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    print(
      'user.embeddedEthereumWallets id: ${user.embeddedEthereumWallets.first.id}',
    );
    return Column(
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => EthWalletScreen(ethereumWallet: wallet),
          ),
        );
      },
      child: Card(
