...
import 'package:privyio/authentication/login_screen.dart';
...
class HomePrivyScreen extends StatefulWidget {
  final PrivyUser user;

  const HomePrivyScreen({super.key, required this.user});

  @override
  State<HomePrivyScreen> createState() => _HomePrivyScreenState();
}

class _HomePrivyScreenState extends State<HomePrivyScreen> {
